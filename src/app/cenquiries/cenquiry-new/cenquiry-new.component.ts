...
@Component({
  selector: 'app-cenquiry-new',
  templateUrl: './cenquiry-new.component.html',
  styleUrls: ['./cenquiry-new.component.css']
})
export class CenquiryNewComponent implements OnInit {
    //assign default page
    page: number = 1;
    filter: string;

  constructor(public cenquiryService: CenquiryService,
